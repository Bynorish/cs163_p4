...
import static LinkedList.ScreenDisplay.CurrentParkStatus;
...
public class ListModel extends AbstractTableModel {
    ...
    public void createList() {
        ...
        try {
            ...
            TentOnly tentOnly1 = new TentOnly("T1", g1, g1,null,4);
            TentOnly tentOnly2 = new TentOnly("T1", g1,g2,null, 8);
            TentOnly tentOnly3 = new TentOnly("T3", g1, g1,null,4);
            TentOnly tentOnly4 = new TentOnly("T4", g1,g2,null, 8);

            RV RV1 = new RV("RV1",g1,g2,null, 1000);
            RV RV2 = new RV("RV2",g1,g2,null, 1000);
            RV RV3 = new RV("RV3",g1,g1,null, 1000);
            RV RV4 = new RV("RV4",g1,g1,null, 1000);
